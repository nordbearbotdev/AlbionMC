...
import xyz.msws.albion.utils.MSG;
import xyz.msws.albion.utils.Utils;
import xyz.msws.albion.utils.Utils.Age;
		...
		new BukkitRunnable() {
			...
			public void run() {
				try (InputStream inputStream = new URL(
					...
					MSG.log(MSG.getString("Updates.Error", "Albion couldn't get updates"));
